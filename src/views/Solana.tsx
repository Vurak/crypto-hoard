...
import { LoadingContainer, NFTCard } from "../components"
...
const Solana = () => {
  ...
  return (
    <div className="flex w-full flex-col content-center">
      <div
        ref={walletRef}
        className={`flex w-full flex-col gap-2 rounded-lg p-2 transition-all duration-200 md:absolute md:left-1/2 md:top-1/2 md:w-2/3 md:-translate-x-1/2 md:-translate-y-1/2`}
      >
        ...
        <LoadingContainer loading={loadingMints}>
          ...
          >
            {NFTMints?.length ? (
              ...
              <div className="mb-4 rounded-lg bg-primary-light text-white">
