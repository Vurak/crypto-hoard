  ...
  return (
    ...
    >
      <div className="fixed inset-0 z-20 px-4">
        ...
        />
        <div className="relative top-1/2 m-4 mx-auto max-h-screen -translate-y-1/2 overflow-y-auto rounded-md bg-primary-light p-5 text-white sm:w-4/5 md:w-2/3 lg:w-1/2 xl:w-1/3">
          <div className="mb-4 flex h-9 w-full">
            <h1 className="mt-auto text-2xl font-bold">{title}</h1>
            <svg
              onClick={() => setActive(false)}
